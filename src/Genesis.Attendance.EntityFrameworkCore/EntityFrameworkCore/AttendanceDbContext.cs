...
using Genesis.Attendance.Attendance.Student;
    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AttendanceConsts.DbTablePrefix + "Department",
                AttendanceConsts.DbSchema);
            b.ConfigureByConvention(); //auto configure for the base class props
        });

        builder.Entity<Teacher>(b =>
        {
            b.ToTable(AttendanceConsts.DbTablePrefix + "Teacher",
                AttendanceConsts.DbSchema);
        ...
        {
            b.ToTable(AttendanceConsts.DbTablePrefix + "Student",
                AttendanceConsts.DbSchema);
            b.ConfigureByConvention();
