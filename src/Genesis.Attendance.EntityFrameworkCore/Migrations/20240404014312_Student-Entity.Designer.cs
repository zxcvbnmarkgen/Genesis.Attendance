...
namespace Genesis.Attendance.Migrations
{
    ...
    [Migration("20240404014312_Student-Entity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Genesis.Attendance.Attendance.Department.Department", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Genesis.Attendance.Attendance.Student.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("GardianContactNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Genesis.Attendance.Attendance.Teacher.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTeacher", (string)null);
                });
            ...
            modelBuilder.Entity("Genesis.Attendance.Attendance.Student.Student", b =>
                {
                    b.HasOne("Genesis.Attendance.Attendance.Teacher.Teacher", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Genesis.Attendance.Attendance.Teacher.Teacher", b =>
                {
                    b.HasOne("Genesis.Attendance.Attendance.Department.Department", null)
                        .WithMany()
